...
\section{Experience}
\vspace*{2mm}
\noindent {\bf Back-end developer}\vspace*{-1mm}
\begin{itemize}
...
\vspace*{2mm}
\noindent {\bf Data analysis:}\vspace*{-1mm}
\begin{itemize}
...
\begin{itemize}
    ...
    \item[-] Development of own \href{http://wines.e-cisac.com/start/}{web application} from scratch (private project).  \href{https://github.com/ydelgadom/non_physics}{Code on Github}.\vspace{-1mm}
