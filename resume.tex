...
\section{Experience}
\vspace*{2mm}
\noindent {\bf Backend engineer:}\vspace*{-1mm}
\begin{itemize}
...
\begin{itemize}
    ...
    \item[-] Machine learning projects and development of own small web application.\vspace{-1mm}
...
{\bf Computer Skills:}
      & Python, Scikit-learn, Django, Tornado\vspace*{1mm}\\ 
      & SQL:  MySQL and Postgresql\vspace*{1mm}\\ 
      & C/C++, Fortran\vspace*{1mm}\\
      & Spark, Cuda, \textsc{mpi}\vspace*{1mm}\\
